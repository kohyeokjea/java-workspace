...
public class Ex0401 {
    public static void main(String[] args) {
        ...
        if (responseChar == 'O') {
            System.out.println("O를 체크하였습니다.");
        } else {
            System.out.println("X를 체크하셨습니다.");
        }
        System.out.println();

        System.out.println("질문 2: 오늘 커피 맛에 만족하시나요? (만족, 보통, 불만족)");
        ...
        System.out.println("질문 3: 오늘 커피 맛에 만족하시나요? (매우 만족, 만족, 보통, 불만족, 매우 불만족)");
        if (responseInt == 1) {
